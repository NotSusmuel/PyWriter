...
while True:
    clear()
    main.helloscreen()
    zeit = input(Fore.CYAN +"Time in Seconds for 1 Letter: " + Style.RESET_ALL)     ### Speed of Typing.
    
    if zeit.isdigit() == True:
        print(Fore.RED + "Please type in a number with . (lowest is 0.0)" + Style.RESET_ALL)
        time.sleep(2)
        clear()
        main.helloscreen()
...
driver.get('https://de4.typewriter.at/index.php?r=typewriter/runLevel')         ### Starting driver(chrome) and logging in.
